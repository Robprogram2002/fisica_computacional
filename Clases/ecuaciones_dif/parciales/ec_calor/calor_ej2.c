...
double f(double x) { return 1.0; }                      // conidición inicial
double g1(double t) { return sin(M_PI * t / 0.2) + 1; } // condición de frontera extremo izquierdo
double g2(double t) { return sin(M_PI * t / 0.2) + 1; } // condición de frontera extremo derecho
