...
double g1(double t) { return -(4 / M_PI) * sin(t) - (4 / (3 * M_PI)) * sin(3 * t) - (4 / (5 * M_PI)) * sin(5 * t); } // condición de frontera extremo izquierdo
double g2(double t) { return -(4 / M_PI) * sin(t) - (4 / (3 * M_PI)) * sin(3 * t) - (4 / (5 * M_PI)) * sin(5 * t); } // condición de frontera extremo derecho
